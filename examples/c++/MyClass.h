...
// Fri Apr 14 16:01:37 2006 by ROOT version 5.06/00
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../rootfiles/tower_jet_pool_howt_3.0.root");
      if (!f) {
         f = new TFile("../rootfiles/tower_jet_pool_howt_3.0.root");
      }
